...
#foreach ($relationship in $entity.sortedClassToOneRelationships)
  ...
  public static ERXFetchSpecification<${entity.classNameWithOptionalPackage}> fetchSpecFor${entity.name}() {
    return new ERXFetchSpecification<${entity.classNameWithOptionalPackage}>(${entity.prefixClassNameWithoutPackage}.ENTITY_DEF, null, null, false, true, null);
  }
#else
  ...
  public static NSArray<${entity.classNameWithOptionalPackage}> fetch${entity.pluralName}(EOEditingContext editingContext, EOQualifier qualifier, NSArray<EOSortOrdering> sortOrderings) {
    ERXFetchSpecification<${entity.classNameWithOptionalPackage}> fetchSpec = new ERXFetchSpecification<${entity.classNameWithOptionalPackage}>(${entity.prefixClassNameWithoutPackage}.ENTITY_DEF, qualifier, sortOrderings);
    fetchSpec.setIsDeep(true);
...
#foreach ($attribute in $entity.sortedClassAttributes)
		...
		@Convert(converter = NSTimestampConverter.class)
#end
#if ($attribute.javaClassName.equals("NSData"))
		@Convert(converter = NSDataConverter.class)
#end
#if (!$attribute.allowsNull)
		@NotNull
#end
